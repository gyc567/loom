<div align="center">
  ...
  <p><strong>面向 agentic software delivery 的 dynamic workflows。</strong></p>
  <p>一套开源交付 harness，把 Claude Code、Codex、OpenCode/opencode、OpenClaw、Cline、Cursor Agent 等 coding agents 变成可重复的软件交付系统。</p>
  <p>
    <a href="./README.md">English</a>
    ·
    <a href="#为什么需要-harness">为什么需要 Harness？</a>
    ·
    <a href="#使用场景">使用场景</a>
    ·
    <a href="#快速开始">快速开始</a>
...
Multi-agent protocol | 让 Claude Code、Codex、OpenCode/opencode、OpenClaw、Cline、Cursor Agent 等工具共享同一套交付流程。
...
<details>
<summary>Loom 只适用于 Codex 吗？</summary>

不是。Loom 是面向多个 coding agents 的 CLI 协议。当前仓库已经提供 Codex、Claude Code 和 opencode 的本地 adapter，工作流也为其他 agent 平台设计。
